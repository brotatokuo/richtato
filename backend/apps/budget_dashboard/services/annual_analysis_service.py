...
class AnnualAnalysisService:
    ...
    def get_annual_analysis(self, user, year: int) -> dict:
        """
    ...
    def _get_monthly_breakdown(self, user, year: int) -> list[dict]:
        """
    ...
    def get_available_years(self, user) -> list[int]:
        """
        ...
        """
        return self.repo.get_transaction_years(user)
