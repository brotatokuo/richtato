...
class CategorySettingsAPIView(APIView):
    ...
    def __init__(self, **kwargs):
        ...
        self.settings_service = CategorySettingsService()
    ...
    def get(self, request):
        ...
        catalog = self.settings_service.get_catalog(request.user)
    ...
    def put(self, request):
        ...
        self.settings_service.update_settings(request.user, request.data)
